...
# -----------------------------------------------------------------------------------------------------------------
# Objective(s): This code contains functions to open the results generated by the different algorithms 
# -----------------------------------------------------------------------------------------------------------------
...
def open_results_online(results_directory,experiment,alpha,r,learning_rate=None):
    ...
    # sparse_dictionary= whether or not a sparse dictionary has been used 
    ### Output
...
def open_results_offline(results_directory,experiment,method,alpha=None):
    ########## Function for replicating the offline ex^periments 
    ### Input:
    # resuts_directory= the directory where the results will be stored 
    # experiment= the number of the experiment
    # alpha= the regularization parameter 
